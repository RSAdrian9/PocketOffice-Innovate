...
import { barChartOutline, cardOutline, clipboardOutline, compassOutline, peopleOutline } from 'ionicons/icons';
...
export class AppComponent {
  ...
  constructor() {
    addIcons({ peopleOutline, cardOutline, compassOutline, clipboardOutline, barChartOutline });
  }

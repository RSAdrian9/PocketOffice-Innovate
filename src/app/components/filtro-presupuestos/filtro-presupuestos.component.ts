...
export class FiltroPresupuestosComponent implements OnInit {
  ...
  aplicarFiltros() {
    ...
    this.filtros = { texto: texto, estado: this.filtros.estado, serie: this.filtros.serie, fechaDesde: this.filtros.fechaDesde, fechaHasta: this.filtros.fechaHasta, orden: this.filtros.orden, nFiltrosAplicados: this.nFiltrosAplicados }
